...
//implementacja klasy "ObliczBMI" i dziedziczenie po klasie BMI
@SuppressWarnings("serial")
public class ObliczBMI extends Frame implements ActionListener {	
	...
	{ 
		...
		// rozmiar okna
		setSize(600, 500);
		//rodzaj rozmieszczenia komponentow
